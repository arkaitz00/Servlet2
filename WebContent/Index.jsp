...
<head>
    ...
    <!-- site metas -->
    <title>La tienda de Arkaitz</title>
    ...
    <!-- end loader -->
     ...
     <div class="sidebar">
            ...
            <nav id="sidebar">
                ...
                <div id="dismiss">
                    <img class="fa fa-arrow-left" src="images/icon.jpg">
                </div>
                    ...
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="dinone"></li>
                                <li class="dinone"></li>
                                <li class="button_user"><a class="button active" href="Login.jsp">Login</a><a class="button" href="Registro.jsp">Register</a></li>
                                <li>
                    ...
                    <div class="full">
                        <div id="main_slider" class="carousel vert slide" data-ride="carousel" data-interval="5000">
                            <div class="carousel-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                <h3>Producto 1 <br> prueba 1</h3>
                                                <p>Este es el producto prueba 1</p>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                <h3>Producto 2<br>Prueba 2</h3>
                                                <p>Este es el producto prueba 2</p>
                                                <a class="main_bt_border" href="#">Order Now</a>
                                            </div>
                                        </div>
                            ...
                            <a class="carousel-control-prev" href="#main_slider" role="button" data-slide="prev">
                                <img src="images/icon.jpg" style="transform: rotate(90deg);">
                            </a>
...
<!-- end Our Client -->
    ...
    <footer>
	    <div class="copyright">
	        <div class="container">
	            <p>© 2021 Todos los derechos reservados. Arkaitz Rodriguez Martinez</p>
	        </div>
	    </div>
    </footer>
    <!-- end footer -->
